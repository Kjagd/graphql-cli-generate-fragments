...
var GenerateFragments = /** @class */ (function () {
    ...
    GenerateFragments.prototype.makeFragments = function (schemaContents, generator) {
        ...
        if (generator === "js") {
            return "// THIS FILE HAS BEEN AUTO-GENERATED BY \"graphql-cli-generate-fragments\"\n// DO NOT EDIT THIS FILE DIRECTLY\n\n// This hacked gql tagged template string is used since the apollo graphql extension \n// relies on the gql tag to identify queries. However, we cannot use the real \n// gql template, as some of the fragments are not valid (such as empty and recursive nested fragments)\nconst gql = (strings: TemplateStringsArray) => strings.raw[0]\n\n" + standardFragments
                .map(function (_a) {
                ...
                .map(function (_a) {
                var name = _a.name, fragment = _a.fragment;
                return "\nexport const " + name + _this.fragmentType.DEEP + "Fragment = gql`\n" + fragment + "`\n";
            })
                .join("") + "\n";
        }
    ...
    GenerateFragments.prototype.printField = function (fieldName, field, ast, fragmentType, indent) {
        ...
        if (constructorName === "GraphQLObjectType") {
            ...
            // TODO: to avoid including empty fragments here, we should probably check something like
            // if (field.type.getFields().filter(<GraphQLScalarType/GraphQLEnumType>).length === 0) {
            //   return null
            // }
            typeName =
